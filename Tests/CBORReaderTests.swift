...
class CBORReaderTests: XCTestCase {
  ...
  func testDecodeByteStrings() {
    ...
    XCTAssertEqual(
      ...
      .indefiniteByteString(Data([0xC0, 0xFF, 0xEE, 0xC0, 0xFF, 0xEE]))
    )
  }
  ...
  func testDecodeUtf8Strings() {
    ...
    XCTAssertEqual(try decode(0x7B, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 3, 0x41, 0x42, 0x43), "ABC")
      XCTAssertEqual(try decode(0x7F, 0x78, 3, 0x41, 0x42, 0x43, 0x63, 0x41, 0x42, 0x43, 0xFF), .indefiniteUtf8String("ABCABC"))
  }
  ...
  func testDecodeArrays() {
    ...
    XCTAssertEqual(
      ...
      .indefiniteArray([255, [1, "ABC"], "ABC"])
    )
      XCTAssertEqual(try decode(0x9F, 0x81, 0x01, 0x82, 0x02, 0x03, 0x9F, 0x04, 0x05, 0xFF, 0xFF), .indefiniteArray([[1], [2, 3], .indefiniteArray([4, 5])]))
  }
  ...
  func testDecodeTagged() {
    ...
    XCTAssertEqual(
      ...
      .tagged(.negativeBignum, .indefiniteMap(["key": ["key": -24]]))
    )
  }
  ...
  func testDecodeMapFromIssue29() {
    ...
    let expectedMap = CBOR.indefiniteMap([
